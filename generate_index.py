...
- Poster in infoCard come sfondo a tutta pagina con dissolvenza morbida
- Poster con risoluzione w780
"""
...
#infoCardOverlay{{position:fixed;top:0;left:0;width:100%;height:100%;z-index:0;background-size:cover;background-position:center center;background-repeat:no-repeat;filter:brightness(0.6);}}
#infoCardContent{{position:relative;z-index:1;padding:20px;max-width:800px;width:90%;margin:auto;}}
...
<script>
// script invariato, solo parentesi corrette
</script>
</body>
</html>
"""
...
def main():
    ...
    for item in entries[:10]:
        latest_entries_html += f"<div class='card'><img class='poster' src='{item['poster']}'><span class='favorite-btn'>★</span></div>"
